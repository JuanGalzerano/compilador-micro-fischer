...
typedef struct {
    ...
    TOKEN t; /* t=0..3: Palabra Reservada; t=ID=4: Identificador */
} RegTS;
...
int main(int argc, char *argv[])
{
    ...
    /* Verifica errores posibles en la lÃ­nea de comandos */
    if (argc == 1) {
        printf("Debe ingresar el nombre del archivo fuente "
               "(en lenguaje Micro) en la linea de comandos\n");
        return -1;
    }
    if (argc != 2) {
